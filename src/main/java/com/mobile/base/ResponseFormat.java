...
public class ResponseFormat {
    ...
    public static String retParam(int status) {
        BaseResponse json = new BaseResponse(status, messageMap.get(String.valueOf(status)));
    ...
    public static String retParam(int status, Object data) {
        BaseResponse json = new BaseResponse(status, messageMap.get(String.valueOf(status)), data);
        return json.toString();
    }
