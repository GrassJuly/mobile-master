...
public class RestExceptionHandler{
    ...
    public String nullPointerExceptionHandler(NullPointerException ex) {
        ex.printStackTrace();
        return ResponseFormat.retParam(1001, null);
    }
    //类型转换异常
    ...
    public String classCastExceptionHandler(ClassCastException ex) {
        ex.printStackTrace();
        return ResponseFormat.retParam(1002, null);
    }
    ...
    public String iOExceptionHandler(IOException ex) {
        ex.printStackTrace();
        return ResponseFormat.retParam(1003, null);
    }
    //未知方法异常
    ...
    public String noSuchMethodExceptionHandler(NoSuchMethodException ex) {
        ex.printStackTrace();
        return ResponseFormat.retParam(1004, null);
    }
    ...
    public String indexOutOfBoundsExceptionHandler(IndexOutOfBoundsException ex) {
        ex.printStackTrace();
        return ResponseFormat.retParam(1005, null);
    }
    //400错误
    ...
    public String requestNotReadable(HttpMessageNotReadableException ex){
        ...
        ex.printStackTrace();
        return ResponseFormat.retParam(400, null);
    }
    //400错误
